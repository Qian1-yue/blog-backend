...
CREATE TABLE IF NOT EXISTS blog_article (
    ...
    CONSTRAINT chk_blog_article_status CHECK (status IN (0, 1, 2))
) ENGINE=InnoDB
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_0900_ai_ci
  COMMENT='博客文章表';
...
CREATE TABLE IF NOT EXISTS blog_comment (
    ...
    status TINYINT NOT NULL DEFAULT 1 COMMENT '状态：0隐藏，1正常，2已删除',
    create_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    PRIMARY KEY (id),
    KEY idx_comment_user_id (user_id),
    KEY idx_comment_article_status_time (article_id, status, create_time),
    ...
    CONSTRAINT fk_comment_article
        ...
        ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT chk_blog_comment_status CHECK (status IN (0, 1, 2))
) ENGINE=InnoDB
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_0900_ai_ci
  COMMENT='博客评论表';
